...
class Sprint008Seeder extends Seeder
{
    ...
    public function run($dataUserBalanceMigration = false, $dataUserBalanceUpdate = false, $dataTranslation = false)
    {
