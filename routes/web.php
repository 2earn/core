...
Route::group(['prefix' => 'API'], function () {
    ...
    Route::post('/handle/paytabs/notification', 'App\Http\Controllers\ApiController@handlePaymentNotification')->name('handle_paytabs_notification')->withoutMiddleware('web');
