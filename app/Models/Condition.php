...
class Condition extends Model
{
    ...
    public static $operators = [
        ...
        ['name' => '[user] #DATE created_at', 'value' => 'u.created_at'],
        ['name' => '[user] #DATE updated_at', 'value' => 'u.updated_at'],
        ...
        ['name' => '[metta user]  #EMAIL email', 'value' => 'metta.email'],
        ...
        ['name' => '[metta user] #DATE birthday', 'value' => 'metta.birthday'],
