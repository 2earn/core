...
class MergeArTranslations extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'translate:merge-ar {source? : Path to the source JSON file to merge}';
     ...
     * @var string
     */
    protected $description = 'Merge Arabic translations from a source JSON file into resources/lang/ar.json';
    ...
    public function handle(): int
    {
        ...
        if (!file_exists($sourcePath)) {
            ...
            if (!$this->argument('source')) {
                ...
                $this->warn("You can specify a different path: php artisan translate:merge-ar path/to/file.json");
            }
            return self::FAILURE;
        }
