...
class MergeEsTranslations extends Command
{
    protected $signature = 'translate:merge-es {source? : Path to the source JSON file to merge}';

    protected $description = 'Merge Spanish translations from a source JSON file into resources/lang/es.json';
    ...
    public function handle(): int
    {
        ...
        if (!file_exists($sourcePath)) {
            ...
            if (!$this->argument('source')) {
                ...
                $this->warn("You can specify a different path: php artisan translate:merge-es path/to/file.json");
            }
            return self::FAILURE;
        }
