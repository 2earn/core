...
class MergeFrTranslations extends Command
{
    protected $signature = 'translate:merge-fr {source? : Path to the source JSON file to merge}';

    protected $description = 'Merge French translations from a source JSON file into resources/lang/fr.json';
    ...
    public function handle(): int
    {
        ...
        if (!file_exists($sourcePath)) {
            ...
            if (!$this->argument('source')) {
                ...
                $this->warn("You can specify a different path: php artisan translate:merge-fr path/to/file.json");
            }
            return self::FAILURE;
        }
