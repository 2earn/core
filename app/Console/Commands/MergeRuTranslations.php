...
class MergeRuTranslations extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'translate:merge-ru {source? : Path to the source JSON file to merge}';
     ...
     * @var string
     */
    protected $description = 'Merge Russian translations from a source JSON file into resources/lang/ru.json';
    ...
    public function handle(): int
    {
        ...
        if (!file_exists($sourcePath)) {
            ...
            if (!$this->argument('source')) {
                ...
                $this->warn("You can specify a different path: php artisan translate:merge-ru path/to/file.json");
            }
            return self::FAILURE;
        }
