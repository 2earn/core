                        ...
                        <div wire:ignore class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                            ...
                            <div class="dropdown-head bg-primary bg-pattern rounded-top">
                                <div class="p-3">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h1 class="m-0 fs-16 text-white"> <?php echo e(__('Notifications')); ?> </h1>
                                        </div>
                                        <div class="col-auto dropdown-tabs">
                                            <span class="badge badge-soft-light fs-13"> 4 <?php echo e(__('New')); ?></span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="<?php echo e(route('account',app()->getLocale() )); ?>"><i
                                    ...
                                    class="align-middle"><?php echo e(__('Account')); ?></span></a>
                            ...
                            <a class="dropdown-item" href="<?php echo e(route('user_balance_cb',app()->getLocale())); ?>"><i
                                    ...
                                    class=""> <?php echo e(__('Cash Balance')); ?> : <b>  <?php echo e(__('DPC')); ?>  <?php echo e($solde->soldeCB); ?></b></span></a>
...
<?php /**PATH /var/www/vhosts/2earn.cash/demo.2earn.cash/resources/views/livewire/top-bar.blade.php ENDPATH**/ ?>
