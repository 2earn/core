...
<html  dir="<?php echo e(config('app.available_locales')[app()->getLocale()]['direction']); ?>"
    data-turbolinks='false' lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" data-topbar="light">
<head>
    <meta charset="utf-8"/>
...
<?php if(app()->getLocale() == 'ar'): ?>
    <style>
        ...
        /*    text-align: end;*/
        /*}*/
        label, h1, h2, h3, h4,h5, a, button, p {
            font-family: ar400;
...
<?php /**PATH /var/www/vhosts/2earn.cash/dev.2earn.cash/resources/views/layouts/master-without-nav.blade.php ENDPATH**/ ?>