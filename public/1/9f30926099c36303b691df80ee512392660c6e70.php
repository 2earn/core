...
} elseif ($_instance->childHasBeenRendered('l3624247555-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3624247555-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3624247555-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3624247555-0');
} else {
    $response = \Livewire\Livewire::mount('identification-check', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3624247555-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
} elseif ($_instance->childHasBeenRendered('l3624247555-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3624247555-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3624247555-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3624247555-1');
} else {
    $response = \Livewire\Livewire::mount('edit-phone-number', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3624247555-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /var/www/vhosts/2earn.cash/demo.2earn.cash/resources/views/livewire/account.blade.php ENDPATH**/ ?>