<div>
        ...
        <script>
            ...
            if (exist && "<?php echo e(Session::get('errorPhoneExiste')); ?>" != ""  ) {
                msg="<?php echo e(Session::get('errorPhoneExiste')); ?>" ;
                //var local = '<?php echo e(app()->getLocale()); ?>';
                // if (local == 'ar') {
                //     msg = "هذا الرقم مسجل!";
                // }
                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center mt-2">
                                        <h5 class="text-primary"><?php echo e(__('Create_New_Account')); ?></h5>
                                        <p class="text-muted"><?php echo e(__('Get_free_account')); ?></p>
                                    </div>
                                    <div class="p-2 mt-4">
...
unset($__errorArgs, $__bag); ?>"
                                                         value=" "
                                                       placeholder="<?php echo e(__('PH_MobileNumber')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="mb-4">
                                                <p class="mb-0 fs-12 text-muted fst-italic"><?php echo e(__('agree_terms')); ?>  <a href=""
                                                              class="text-primary text-decoration-underline fst-normal fw-medium"><?php echo e(__('Terms_of_Use')); ?></a></p>
                                            </div>

                                            <div class="mt-4">
                                                <button onclick="signupEvent()" class="btn btn-success w-100 btn2earn" type="button">
                                                    <?php echo e(__('Sign up')); ?></button>
                                            </div>
                            ...
                            <div class="mt-4 text-center">
                                <p class="mb-0"><?php echo e(__('have_account')); ?> <a  href="<?php echo e(route('login',['locale'=>app()->getLocale()])); ?>"
...
<?php /**PATH /var/www/vhosts/2earn.cash/demo.2earn.cash/resources/views/livewire/registre.blade.php ENDPATH**/ ?>