...
} elseif ($_instance->childHasBeenRendered('iyAXsjG')) {
    $componentId = $_instance->getRenderedChildComponentId('iyAXsjG');
    $componentTag = $_instance->getRenderedChildComponentTagName('iyAXsjG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iyAXsjG');
} else {
    $response = \Livewire\Livewire::mount('top-bar', []);
    $html = $response->html();
    $_instance->logRenderedChild('iyAXsjG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
