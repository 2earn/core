                    ...
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 pt-4 mb-4">
                            <div class="mb-sm-5 pb-sm-4 pb-5">
                                <img src="<?php echo e(asset('assets/images/icon-learn.png')); ?>" alt="" height="120" class="move-animation">
                            </div>
                            <div class="mb-5">
                                <h1 class="display-2 coming-soon-text">Coming Soon</h1>
                                <h2 class="">Learn2earn.cash</h2>
                            </div>
                            <div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/2earn.cash/demo.2earn.cash/resources/views/coming-soon-learn.blade.php ENDPATH**/ ?>