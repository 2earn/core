            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <div class="row justify-content-center">
                            <div class="col-lg-9">
                                <h4 class="mt-4 fw-semibold"><?php echo e(__('KYC_Verification')); ?></h4>
                                <p class="text-muted mt-3">
                                    <?php echo e(__('Txt_KYC_Verification')); ?>
                                ...
                                <div class="mt-4">
                                    ...
                                    <?php echo e(__('Click_here_for_Verification')); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('Validation Compte')); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <?php echo e(__('voter_demande_déja_en_cours')); ?>
            ...
            <div class="modal-content">
                <div class="modal-header p-3">
                    <h5 class="modal-title text-uppercase" id="exampleModalLabel">
                        <?php echo e(__('Verify_your_Account')); ?>
                            ...
                            <ul class="nav nav-pills nav-justified custom-nav" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link p-3" id="pills-payment-tab" data-bs-toggle="pill"
                                        ...
                                        <?php echo e(__('Interface_Verification')); ?>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link p-3" id="pills-finish-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="false"><?php echo e(__('Verified')); ?>
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-check form-switch   ms-5 me-5 mb-3" dir="ltr">
                                            ...
                                            <label class="form-check-label"
                                                   for="customSwitchsizesm"><?php echo e(__('I want to receive an SMS when my identification completed successfully')); ?></label>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <!--end col-->
                                        ...
                                        <div class=''
                                            ...
                                            <div class="position-relative">
                                                <div class="card p-2 text-center">
                                                    <h6><?php echo e(__('Opt_verif_mail')); ?> <br> <?php echo e(__('To_verif_Account')); ?>

                                                    </h6>
                                                    <div><span><?php echo e(__('Code_send_To')); ?></span>
                                                        <small>*******<?php echo e(substr(getActifNumber()->fullNumber, -3)); ?></small>
                                                    </div>
                                                    <div id="otp"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="hstack align-items-start gap-3 mt-4">
                                            <button type="button" class="btn btn-light btn-label previestab"
                                                ...
                                                <?php echo e(__('Back_to_personnel')); ?>
                            ...
                            <div class="tab-pane fade" id="pills-payment" role="tabpanel"
                                ...
                                <div class="row" style="margin: 20px">
                                    ...
                                    <div class="col-6">
                                        <div>
                                            <label class="form-label"><?php echo e(__('Back ID')); ?></label>
                                        </div>
                                        <div>
                                ...
                                <div class="d-flex align-items-start gap-3 mt-4">
                                    <button type="button" class="btn btn-light btn-label previestab"
                                            ...
                                            class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></i>
                                        <?php echo e(__('Back_to_mail_verif')); ?>

                                    </button>
                                    <button onclick="saveimg()" type="button"
                                            class="btn btn-primary btn-label right ms-auto nexttab"
                                            data-nexttab="pills-finish-tab"><i
                                            class="ri-save-line label-icon align-middle fs-16 ms-2"></i><?php echo e(__('Submit')); ?>
                            ...
                            <div class="tab-pane fade" id="pills-finish" role="tabpanel"
                                ...
                                <div class="row text-center justify-content-center py-4">
                                    <div class="col-lg-11">
                                        ...
                                        <h5><?php echo e(__('Verification_Completed')); ?></h5>
                                        ...
                                        <p class="text-muted mb-4">
                                            <?php echo e(__('txt_Verification_Completed')); ?>
                                        ...
                                        <div class="hstack justify-content-center gap-2">
                                            <button onclick="doneVerify()" type="button" class="btn btn-ghost-success"
                                                    data-bs-dismiss="modal"><?php echo e(__('Done')); ?><i
...
<?php /**PATH /var/www/vhosts/2earn.cash/demo.2earn.cash/resources/views/livewire/identification-check.blade.php ENDPATH**/ ?>