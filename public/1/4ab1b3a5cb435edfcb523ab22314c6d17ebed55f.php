...
<head>
    ...
    <meta content="2earn" name="description"/>
...
} elseif ($_instance->childHasBeenRendered('vjHSDk8')) {
    $componentId = $_instance->getRenderedChildComponentId('vjHSDk8');
    $componentTag = $_instance->getRenderedChildComponentTagName('vjHSDk8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vjHSDk8');
} else {
    $response = \Livewire\Livewire::mount('top-bar', []);
    $html = $response->html();
    $_instance->logRenderedChild('vjHSDk8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /var/www/vhosts/2earn.cash/demo.2earn.cash/resources/views/layouts/master.blade.php ENDPATH**/ ?>
