                ...
                <div class="card-body">
                    ...
                    <ul id="pills-tab" class="nav nav-tabs nav-justified mb-3" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" data-bs-toggle="tab" href="#cash_bfs" role="tab" aria-selected="false" tabindex="-1">
                                <?php echo __('Cash >> BFS'); ?>

                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link align-middle" data-bs-toggle="tab" href="#bfs_funding" role="tab" aria-selected="false" tabindex="-1">
                                <?php echo e(__('BFS Funding')); ?>

                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link align-middle" data-bs-toggle="tab" href="#bfs_sms" role="tab" aria-selected="false" tabindex="-1">
                                <?php echo __('BFS >> SMS'); ?>

                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a id="pills-profile-tab" class="nav-link" data-bs-toggle="tab" href="#me_others" role="tab" aria-selected="true">
                                <?php echo __('Requests: Me >> Others'); ?>

                                <?php if($requestOutAccepted>0): ?>
                                    <button  id="btnNotRequestOutAcccepted"  type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" >
                                        <i class=" ri-user-follow-line text-success fs-22"></i>
                                        <span  id="pOutAccepted" class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-success"> <?php echo e($requestOutAccepted); ?></span>
                                    </button>

                                <?php endif; ?>
                                <?php if($requestOutRefused>0): ?>
                                    <button id="btnNotRequestOutRefused" type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" >
                                        <i class=" ri-user-unfollow-line text-danger fs-22"></i>
                                        <span id="pOutRefused" class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger"><?php echo e($requestOutRefused); ?></span>
                                    </button>
                                <?php endif; ?>
                        ...
                        <li class="nav-item" role="presentation">
                            <a id="pills-contact-tab" class="nav-link" data-bs-toggle="tab" href="#others_me" role="tab" aria-selected="true">
                                <?php echo __('Requests: Others >> Me'); ?>

                                <?php if($requestInOpen>0): ?>
                                    <button id="btnNotRequestInOpen" type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" >
                                        <i class="  ri-user-received-2-line text-primary fs-22"></i>
                                        <span id="pIn" class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-primary">  <?php echo e($requestInOpen); ?></span>
                                    </button>
                                <?php endif; ?>
                    ...
                    <div class="tab-content text-muted">
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-xxl-4 mx-auto ">
                                            <div class="input-group">
                                                <span class="input-group-text" id="inputGroup-sizing-default"><?php echo e(__('Enter your amount')); ?></span>
                                                <input type="number"
                                       ...
                                       <div class="col-1 mx-auto d-xxl-none">
                                        ...
                                        <div class="col-xxl-4 mx-auto ">
                                            <div class="input-group">
                                                <span class="input-group-text" id="inputGroup-sizing-default"><?php echo e(__('Balance For Shopping')); ?></span>
                                                <input type="number"
                                        ...
                                        <div class="col-6 mx-auto ">
                                            <button class="btn btn-primary w-100 mt-3" onclick="ConfirmExchange()" id="exchange"><?php echo e(__('Exchange Now')); ?></button>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-xxl-8 mx-auto ">
                                            <div class="input-group">
                                                <span class="input-group-text" id="inputGroup-sizing-default"><?php echo e(__('backand_Amount_to_Fund_in_DCP')); ?></span>
                                        ...
                                        <div class="col-xxl-8 mx-auto text-center ">
                                            ...
                                            <div class="form-check form-check-inline ">
                                                ...
                                                <input class="form-check-input" type="radio" name="inlineRadioOptions"   value="paypal" id="paypal" onclick="setPaymentFormTarget(0)">
                                                <label class="form-check-label fs-5 text-primary" for="flexSwitchCheckChecked"><i class="ri-paypal-fill me-2 "></i><?php echo e(__('Paypal')); ?></label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadioOptions"  value="creditCard" id="creditCard" onclick="setPaymentFormTarget(1)">
                                                <label class="form-check-label fs-5 text-success " for="flexSwitchCheckChecked"><i class="ri-bank-card-fill me-2 "></i><?php echo e(__('Creditcard')); ?></label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadioOptions"  value="publicUser" id="publicUser"  onclick="setPaymentFormTarget(3)">
                                                <label class="form-check-label fs-5 text-danger " for="flexSwitchCheckChecked"><i class="ri-team-fill me-2"></i><?php echo e(__('PublicUsers')); ?></label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadioOptions"  value="upline" id="upline" onclick="setPaymentFormTarget(2)">
                                                <label class="form-check-label fs-5 text-warning" for="flexSwitchCheckChecked"><i class="ri-user-2-fill me-2 "></i><?php echo e(__('requstAdmin')); ?></label>
                                            </div>
                                        </div>
                                        <div class="col-xxl-8 mx-auto ">
                                            <button class="btn btn-primary w-100 mt-3"  id="pay"><?php echo e(__('backand.Fund')); ?></button>
                                        </div>
                        ...
                        <div class="tab-pane" id="bfs_sms" role="tabpanel">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="alert alert-info border-0 rounded-top rounded-0 m-0 d-flex align-items-center mb-3" >
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-xxl-8 mx-auto ">
                                            <div class="input-group">
                                                <span class="input-group-text" id="inputGroup-sizing-default"><?php echo e(__('Enter number of SMS')); ?></span>
                                                <input type="number"
                                                       oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
                                                       name="NSMS" id="NSMS"
                                                       class="form-control text-center" placeholder="" onpaste="handlePaste(event)">
                                                <span class="input-group-text" id="inputGroup-sizing-default"><?php echo e(__('Enter your amount')); ?></span>
                                        ...
                                        <div class="col-xxl-8 mx-auto ">
                                            <button class="btn btn-primary w-100 mt-3"  id="submitExchangeSms" onclick="ConfirmExchangeSms()" > <?php echo e(__('Exchange Now')); ?></button>
                                        </div>
                                    ...
                                    <table class=" table table-responsive tableEditAdmin"
                                        ...
                                        <?php $__currentLoopData = $requestFromMee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td onclick="hiddenTr(<?php echo e($value->numeroReq); ?>)"><span> <?php echo e($value->date); ?></span>
                                                </td>
                                            ...
                                            <tr hidden="true" id=<?php echo e($value->numeroReq); ?>>
                                                <td colspan="12">
                                                    <table class=" table table-responsive table2earn " style="width: 100%"
                                                    >
                                                        <thead>
                                                        <tr>
                                    ...
                                    <table class=" table table-responsive tableEditAdmin"
                                        ...
                                        <?php $__currentLoopData = $requestToMee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><span><?php echo e(number_format((float)$value->amount, 2, '.', ' ')); ?> </span></td>
...
<?php /**PATH /var/www/vhosts/2earn.cash/dev.2earn.cash/resources/views/livewire/financial-transaction.blade.php ENDPATH**/ ?>