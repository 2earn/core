        ...
        <div class="flex-grow-1 overflow-hidden">
            <div class="d-flex justify-content-between align-items-center mb-2 gap-2">
                <h6 class="fs-15 fw-bold mb-0 text-dark d-flex align-items-center gap-2">
                    {{ __('notifications.settings.deal_change_request_approved') }}
                    @if ($notification->read_at === null)
            ...
            <p class="text-muted mb-3 fs-14" style="line-height: 1.6;">
                {{ __('notifications.deal_change_request_approved.body', ['deal_name' => $notification->data['message_params']['deal_name'] ?? '']) }}
            </p>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                <a href="{{ \App\Helpers\NotificationHelper::localizeUrl($notification->data['url'],app()->getLocale()) }}"
                   ...
                   style="transition: all 0.3s; box-shadow: 0 2px 6px rgba(var(--bs-success-rgb), 0.25);">
                    <span class="fw-semibold">{{ __('notifications.deal_change_request_approved.action') }}</span>
