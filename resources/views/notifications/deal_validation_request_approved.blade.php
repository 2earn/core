<div class="text-reset notification-item d-block dropdown-item position-relative border-0 border-bottom @if ($notification->read_at === null) bg-primary bg-opacity-10 @else bg-white @endif"
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <span class="fw-semibold" style="font-size: 0.8rem;">{{ __('notifications.deal_validation_request_approved.action') }}</span>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                {{ __('notifications.deal_validation_request_approved.body', ['deal_name' => $notification->data['message_params']['deal_name'] ?? '']) }}
            <p class="text-muted mb-2 fs-13" style="line-height: 1.5;">
                ...
                @if ($notification->read_at === null)
                <h6 class="fs-14 fw-semibold mb-1 text-dark">{{ __('notifications.settings.deal_validation_request_approved') }}</h6>
