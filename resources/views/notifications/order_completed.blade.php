<div
    ...
    <div class="d-flex align-items-start p-1 gap-1 position-relative"
         style="background: @if ($notification->read_at === null) linear-gradient(135deg, rgba(var(--bs-primary-rgb), 0.05) 0%, rgba(var(--bs-primary-rgb), 0.02) 100%) @endif;">
        <div class="flex-grow-1 overflow-hidden">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                <a href="{{ \App\Helpers\NotificationHelper::localizeUrl($notification->data['url'],app()->getLocale()) }}"
                   class="btn btn-sm btn-primary p-1 d-inline-flex align-items-center gap-2 rounded-pill"
