<div class="row mb-2" id="wellcome-message">
    @php
        $isRtl = app()->getLocale() === 'ar';
    @endphp
    <div class="col-12  border-0 shadow-lg overflow-hidden dir="{{$isRtl ? 'rtl' : 'ltr'}}"
    style="background: linear-gradient(135deg, #00aaf2 0%, #e502f5 100%); border-radius: 20px;">
    <div class="card-body  position-relative">
        <div
            class="d-flex align-items-center {{$isRtl ? 'flex-lg-row-reverse' : 'flex-lg-row'}} flex-column {{$isRtl ? 'text-lg-end' : 'text-lg-start'}} text-center">
            ...
            <div class="flex-grow-1 text-lg-start text-center">
                <div
                    class="d-flex align-items-center justify-content-lg-{{$isRtl ? 'end' : 'start'}} justify-content-center gap-3 mb-1">
                    <div>
            ...
            <div class="flex-shrink-0 text-lg-{{$isRtl ? 'start' : 'end'}} text-center">
                <div
                    class="d-inline-flex align-items-center gap-3 bg-opacity-15 px-4 py-3 shadow-sm {{$isRtl ? 'flex-row-reverse' : ''}}"
        ...
        <div class="position-absolute bottom-0 {{$isRtl ? 'end-0' : 'start-0'}} opacity-10"
