                        ...
                        <div class="card mb-3 border">
                            <div class="card-body py-3">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <div>
                                        <strong class="text-primary">{{ getUserDisplayedName($comment->user->idUser) }}</strong>
                                    </div>
                    ...
                    <div class="mt-4 pt-4 border-top">
                        <div class="alert alert-warning border-0 mb-3">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="badge bg-warning text-dark ms-auto">{{ count($unvalidatedComments) }}</span>
                            </div>
                        </div>
                        ...
                        @foreach($unvalidatedComments as $comment)
                            <div class="card border-warning mb-3">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <div>
                                            <strong class="text-dark">{{ getUserDisplayedName($comment->user->idUser) }}</strong>
