    ...
    <div class="row">
        <div>
            ...
            <div class="row">
                @if(!$disabled)
                    <div
                        class="col-sm-12 card shadow-sm @if(Route::getCurrentRoute()->getName()=="validate_account") d-none   @endif">
                ...
                <div class="col mx-1 card shadow-sm" id="profile">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            ...
                            @if($user['status']==\App\Enums\StatusRequest::ValidNational->value||$user['status']==\App\Enums\StatusRequest::ValidInternational->value)
                                <div class="mb-3">
