            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <h6 class="text-muted">{{__('Platform')}}: <strong
                                    class="text-dark">{{$viewChangesData['platform_name'] ?? 'N/A'}}</strong></h6>
                            <p class="text-muted mb-0 small">{{__('Requested at')}}
                                : {{$viewChangesData['requested_at'] ?? 'N/A'}}</p>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover mb-0">
                                ...
                                @else
                                    <tr>
                                        <td colspan="3"
                                            class="text-center text-muted">{{__('No changes available')}}</td>
                                    </tr>
                                @endif
                                </tbody>
                            </table>
                            ...
                            <table class="table table-sm table-bordered mb-0">
                                ...
                                @foreach($approveRequestChanges as $field => $change)
                                    <tr>
                                        ...
                                        <td><span
                                                class="text-muted">{{ is_bool($change['old'] ?? null) ? ($change['old'] ? 'Yes' : 'No') : ($change['old'] ?? 'N/A') }}</span>
                                        </td>
                                        <td><span
                                                class="text-success fw-bold">{{ is_bool($change['new'] ?? null) ? ($change['new'] ? 'Yes' : 'No') : ($change['new'] ?? 'N/A') }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
