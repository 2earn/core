            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <i class="fas fa-circle-notch me-1"></i>{{__(\App\Enums\DealStatus::tryFrom($deal->status)?->name)}}
                    </span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0 bg-light h-100">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <div
                                        class="avatar-sm rounded bg-primary-subtle text-primary d-flex align-items-center justify-content-center">
                            ...
                            <div class="card-body">
                                ...
                                <div class="vstack gap-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span
                                            class="badge bg-info-subtle text-info">{{$deal->discount}} {{config('app.percentage')}}</span>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span
                                            class="badge bg-primary-subtle text-primary">{{$deal->final_commission}} %</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="vstack gap-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span
                                            class="fw-semibold text-success">{{formatSolde($deal->total_commission_value)}} {{$currency}}</span>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="text-muted">{{__('Total unused cashback value')}}</span>
                                        <span
                                            class="fw-semibold text-info">{{formatSolde($deal->total_unused_cashback_value)}} {{$currency}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="vstack gap-2">
                                    ...
                                    <div class="border-bottom pb-2">
                                        ...
                                        <div class="d-flex gap-2 flex-wrap">
                                            <small
                                                class="badge bg-success-subtle text-success">{{formatSolde($earn_profit,2)}} {{$currency}}</small>
                                            <small
                                                class="badge bg-primary-subtle text-primary">{{formatSolde($deal->cash_company_profit,2)}} {{$currency}}</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border-bottom pb-2">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            ...
                                            <span
                                                class="badge bg-warning-subtle text-warning">{{$deal->jackpot}} %</span>
                                        </div>
                                        <div class="d-flex gap-2 flex-wrap">
                                            <small
                                                class="badge bg-success-subtle text-success">{{formatSolde($jackpot,2)}} {{$currency}}</small>
                                            <small
                                                class="badge bg-primary-subtle text-primary">{{formatSolde($deal->cash_jackpot,2)}} {{$currency}}</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border-bottom pb-2">
                                        ...
                                        <div class="d-flex gap-2 flex-wrap">
                                            <small
                                                class="badge bg-success-subtle text-success">{{formatSolde($tree_remuneration,2)}} {{$currency}}</small>
                                            <small
                                                class="badge bg-primary-subtle text-primary">{{formatSolde($deal->cash_tree,2)}} {{$currency}}</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="pb-1">
                                        ...
                                        <div class="d-flex gap-2 flex-wrap">
                                            <small
                                                class="badge bg-success-subtle text-success">{{formatSolde($proactive_cashback)}} {{$currency}}</small>
                                            <small
                                                class="badge bg-primary-subtle text-primary">{{formatSolde($deal->cash_cashback,2)}} {{$currency}}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
