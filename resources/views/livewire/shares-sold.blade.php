...
<div>
    ...
    @section('content')
        ...
        @component('components.breadcrumb')
            @slot('li_1')@endslot
            @slot('title') {{ __('Shares Sold') }} @endslot
        @endcomponent
@section('css')
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6" ><div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="row align-items-end g-0">
                                <div class="col-6">
                                    <h5 class="mb-1 mt-4">{{number_format(getGiftedShares()/getSelledActions()*100,2)}}%</h5>
                                    <p class="text-danger fw-medium mb-0"><span class="text-muted ms-2 fs-12"></span></p>
                                </div><!-- end col -->
                                <div class="col-6">
                ...
                <div class="col-xl-4 col-md-6" ><div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="row align-items-end g-0">
                                <div class="col-6">
                                    <h5 class="mb-1 mt-4" id="realrev">${{number_format(getRevenuSharesReal(),2)}}</h5>
                                    <p class="text-danger fw-medium mb-0"><span class="text-muted ms-2 fs-12"></span></p>
                                </div><!-- end col -->
                                <div class="col-6">
                                    <div class="apex-charts crypto-widget" data-colors='["--vz-danger", "--vz-transparent"]' id="binance_sparkline_charts" dir="ltr"></div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-12">
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="button"   id="realsold-submit" class="btn btn-primary">{{ __('Submit') }}</button>
                                    </div>
                                </div><!--end col-->
                            </div><!--end row-->
                        </form>
