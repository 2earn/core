<div>
    @section('title'){{ __('Share_sold') }} @endsection
    @section('content')
        ...
        <div class="row">
            <div class="col-xxl-9">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-danger fw-medium mb-0"><span class="text-muted ms-2 fs-12"></span>
                                        </p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        <h5 class="mb-1 mt-4">
                                            {{ number_format((getGiftedShares() / getSelledActions()) * 100, 2) }}%</h5>
                                        <p class="text-danger fw-medium mb-0"><span class="text-muted ms-2 fs-12"></span>
                                        </p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0"><span class="text-muted ms-2 fs-12"></span>
                                        </p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                ...
                <div class="card" id="marketList">
                    ...
                    <div class="card-body table-responsive">
                        <table id="shares-sold" class="table nowrap dt-responsive align-middle table-hover table-bordered"
                            style="width:100%">
            ...
            <div class="col-xxl-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table id="transfert" class="table nowrap dt-responsive align-middle table-hover table-bordered"
                            style="width:100%">
                            <tbody class="body2earn">
                            </tbody>
