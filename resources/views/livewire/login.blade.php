<div data-turbolinks='false'>
                                            ...
                                            <form>
                                                ...
                                                <div dir="ltr" class="mb-3">
                                                    ...
                                                    <input type="tel" name="mobile" id="phone"
                                                        ...
                                                        value="" placeholder="{{ __('PH_MobileNumber') }}">
                                                    @error('email')
                                                ...
                                                <div class="mt-4">
                                                    <button onclick="functionLogin()"
                                                        class="btn btn-success w-100 btn2earn" type="button"
                                                        id="btn">{{ __('Sign in') }}
                                                    </button>
                                                </div>
                                                <div class="center" style=" display: flex;  justify-content: center;">
                                                    <div class="dropdown ms-1 topbar-head-dropdown header-item  ">
                                                        <button type="button"
                                                            ...
                                                            aria-expanded="false">
                                                            <img src="{{ URL::asset('/assets/images/flags/' . config('app.available_locales')[app()->getLocale()]['flag'] . '.svg') }}"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            @foreach (config('app.available_locales') as $locale => $value)
                                                                <a href="{{ route($var, ['locale' => $locale]) }} "
                                                                    ...
                                                                    data-lang="en" title="{{ __('lang' . $locale) }}"
    ...
    <script>
        ...
        function functionLogin(dd) {
            ...
            window.livewire.emit('login', $("#phone").val(), $("#ccodelog").val(), $("#password-input").val(), $(
                "#isoCountryLog").val());
        }
    </script>
</div>
