                    ...
                    <form>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="Description"
                                      wire:model="description" placeholder="{{__('Enter Description')}}"></textarea>
                        ...
                        <div class="form-group mb-3">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="showResult">{{__('showResult')}}</label>
                                <div class="form-text">{{__('Required field')}}</div>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <div class="form-check">
                                <input class="form-check-input" wire:model="showAchievement" type="checkbox" value=""
                                       id="showAchievement" placeholder="{{__('showAchievement')}}" checked>
                                <label class="form-check-label" for="showAchievement">{{__('showAchievement')}}</label>
                                <div class="form-text">{{__('Required field')}}</div>
                            </div>
                        </div>
