                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1 overflow-hidden">
                            <p class="text-uppercase fw-medium text-muted text-truncate   mb-0">{{ __('Cash Balance') }}
                            </p>
                        </div>
                            ...
                            <h5 class="text-success fs-14 mb-0">
                                ...
                                @if ($cashBalance - $arraySoldeD[0] > 0)
                                    <p class="text-success" style="max-height: 5px">
                                        +{{ $cashBalance - $arraySoldeD[0] }}
                                        <i class="ri-arrow-right-up-line fs-13 align-middle"></i>
                                    </p>
                                @elseif($cashBalance - $arraySoldeD[0] < 0)
                                    <p class="text-danger" style="max-height: 5px">{{ $cashBalance - $arraySoldeD[0] }}
                                        <i class="ri-arrow-right-down-line fs-13 align-middle"></i></p>
                                @endif
                            </h5>
                        </div>
                    </div>
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        ...
                        <div class="avatar-sm flex-shrink-0">
                            <lord-icon src="{{ URL::asset('assets/icons/298-coins-gradient-edited.json') }}"
                        ...
                        <div class="flex-shrink-0">
                            <h5 class="text-success fs-14 mb-0">
                                ...
                                @elseif($balanceForSopping - $arraySoldeD[1] < 0)
                                    <p class="text-danger" style="max-height: 5px">
                                        {{ $balanceForSopping - $arraySoldeD[1] }} <i
        ...
        <div class="col-xl-2 col-md-6">
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="mb-4 fs-22 fw-semibold ff-secondary">{{ __('DPC') }}<span
                                    class="counter-value" data-target="{{ (int) $discountBalance }}">0</span><small
                                    class="text-muted fs-13">
        ...
        <div class="col-xl-2 col-md-6">
            ...
            <div class="card card-animate">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1 overflow-hidden">
                            <p class="text-uppercase fw-medium text-muted text-truncate   mb-0">{{ __('SMS Solde') }}
                            </p>
                        </div>
                        <div class="flex-shrink-0">
                            <h5 class="text-success fs-14 mb-0">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <h5 class="text-success fs-14 mb-0">
                                ...
                                <p class="text-success" style="max-height: 5px">
                                    {{ actualActionValue(getSelledActions()) }}
                                    <i class="ri-arrow-right-up-line fs-13 align-middle"></i>
                                </p>
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-3">
                        <div>
                            ...
                            <span class="badge bg-light text-success  ms-2 mb-0"><i
                                    class="ri-arrow-up-line align-middle"></i>{{ number_format(getUserActualActionsProfit(Auth()->user()->idUser), 2) }}
                                $</span>

                        </div>
                        <div class="avatar-sm flex-shrink-0">
                            <lord-icon src="{{ URL::asset('assets/icons/wired-gradient-751-share.json') }}"
                                trigger="loop" colors="primary:#464fed,secondary:#bc34b6"
                                style="width:55px;height:55px">
                            </lord-icon>
                        </div>
            ...
            <div class="modal-body">
                ...
                <form class="needs-validation" novalidate>
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div>
                                <label for="customer-name" class="col-form-label">{{ __('Number Of Shares') }}
                                </label>
                            ...
                            <div class="col-12 mb-3">
                                <div>
                                    ...
                                    <input type="number" disabled class="form-control" id="profit"
                                        value="0000">
                                </div>
                            </div><!--end col-->
                            <div class="col-lg-12">
