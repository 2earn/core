<div class="row">
                ...
                <div class="card-body p-4">
                    <div class="row align-items-center team-row">
                        <div class="col-12">
                            <div class="text-center">
                                <a href="{{route('business_sector_show',['locale'=> app()->getLocale(),'id'=>$businessSector->id])}}">
                                    <h5 class="fs-16 mb-1">{{$businessSector->name}}</h5>
                                </a>
                                @if($businessSector->description)
                                    <p class="text-muted mb-0">{{Str::limit($businessSector->description, 100)}}</p>
                                @endif
                            </div>
                        </div>
                        <div class="col-12 mt-3">
                            <div class="text-center">
                                <a href="{{route('business_sector_show',['locale'=> app()->getLocale(),'id'=>$businessSector->id])}}"
                                   class="btn btn-light view-btn w-100">View Details</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row mt-4">
        <div class="col-12 text-center">
            <a href="{{route('business_sector_index',['locale'=> app()->getLocale()])}}" class="btn btn-primary">
                View All Business Sectors <i class="ri-arrow-right-line align-middle ms-1"></i>
            </a>
        </div>
    </div>
</div>
