<div class="{{getContainerType()}}">
    ...
    <div class="card card-border-effect-none shadow-sm">
                    ...
                    @if($order->orderDetails()->count())
                        <div class="mt-2">
                            @foreach($order->orderDetails()->get() as $key => $orderDetail)
                                <div
                                    class="card cart mb-3 shadow-sm @if($orderDetail->item()->first()->deal()->exists()) border-success @else border @endif">
                                    <div
                                        class="card-header @if($orderDetail->item()->first()->deal()->exists()) bg-success-subtle @else bg-light @endif">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card card-border-effect-none h-100">
                                                    <div class="card-header bg-light">
                                                        <h6 class="card-title mb-0">
                                                        ...
                                                        @if($currentRouteName=="orders_detail")
                                                            <ul class="list-group list-group-flush">
                                                                ...
                                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                                                    ...
                                                                    <span
                                                                        class="badge bg-success-subtle text-success">{{$orderDetail->unit_price}} {{config('app.currency')}}</span>
                                                                </li>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card border h-100">
                                                    <div class="card-header bg-light">
                                                        <h6 class="card-title mb-0">
                                                            <i class="ri-money-dollar-circle-line text-success me-2"></i>{{__('Prices')}}
                                                            & {{__('Shipping')}}
                                                        </h6>
                                                    </div>
                                                    <div class="card-body">
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                                <strong><i
                                                                        class="ri-calculator-line text-primary me-1"></i>{{__('Calculation')}}
                                                                </strong>
                                                            ...
                                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                                <strong><i
                                                                        class="ri-price-tag-3-line text-success me-1"></i>{{__('Total Amount')}}
                                                                </strong>
                                                                <span class="badge bg-primary fs-14">
                                                            ...
                                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                                <strong><i
                                                                        class="ri-truck-line text-warning me-1"></i>{{__('Shipping')}}
                                                                </strong>
                                                                ...
                                                                <div class="row g-3">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="card border">
                                                                            <div class="card-header bg-light">
                                                                                <small
                                                                                    class="fw-bold text-muted">{{__('Partner Discount')}}</small>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="card border">
                                                                            <div class="card-header bg-light">
                                                                                <small
                                                                                    class="fw-bold text-muted">{{__('2earn Discount')}}</small>
                                                                            </div>
                                                                            <div class="card-body p-2">
                                                                                <div
                                                                                    class="d-flex justify-content-between align-items-center mb-2">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="card border">
                                                                            <div class="card-header bg-light">
                                                                                <small
                                                                                    class="fw-bold text-muted">{{__('Deal Discount')}}</small>
                                                                            </div>
                                                                            <div class="card-body p-2">
                                                                                <div
                                                                                    class="d-flex justify-content-between align-items-center mb-2">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="card border-success">
                                                                            <div
                                                                                ...
                                                                                <small
                                                                                    class="fw-bold text-success">{{__('Total discount')}}</small>
                                                                            </div>
                                                                            <div
                                                                                class="card-body p-2 d-flex align-items-center justify-content-center">
                                                                                        <span
                                                                                            class="badge bg-success fs-14">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6 col-lg-3">
                                                        <div class="card border h-100">
                                                            <div class="card-header bg-light">
                                                                <small
                                                                    class="fw-bold text-muted">{{__('Reference')}}</small>
                                                            </div>
                                                            <div
                                                                class="card-body d-flex align-items-center justify-content-center">
                                                                        <span
                                                                            class="badge bg-primary-subtle text-primary fs-14">
                                                                            {{$discount->reference}}
                                                                        </span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6 col-lg-3">
                                                        <div class="card border-danger h-100">
                                                            <div class="card-header bg-danger-subtle">
                                                                <small
                                                                    class="fw-bold text-danger">{{__('Value')}}</small>
                                                            </div>
                                                            <div
                                                                class="card-body d-flex align-items-center justify-content-center logoTopDBLabel">
                                                    ...
                                                    <div class="col-md-6 col-lg-3">
                                                        <div class="card border-success h-100">
                                                            <div class="card-header bg-success-subtle">
                                                                <small
                                                                    class="fw-bold text-success">{{__('Current balance')}}</small>
                                                            </div>
                                                            <div
                                                                class="card-body d-flex align-items-center justify-content-center logoTopDBLabel">
                                                    ...
                                                    <div class="col-md-6 col-lg-3">
                                                        <div class="card border h-100">
                                                            <div class="card-header bg-light">
                                                                <small
                                                                    class="fw-bold text-muted">{{__('Created at')}}</small>
                                                            </div>
                                                            <div
                                                                class="card-body d-flex align-items-center justify-content-center">
                                                            ...
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="col-md-6 col-lg-2">
                                                                    <div class="card border h-100">
                                                                        ...
                                                                        <div
                                                                            class="card-body d-flex align-items-center justify-content-center">
                                                                                    <span
                                                                                        class="badge bg-info-subtle text-info fs-14">
                                                                                        {{$bfs->reference}}
                                                                                    </span>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-6 col-lg-2">
                                                                    <div class="card border-danger h-100">
                                                                        ...
                                                                        <div
                                                                            class="card-body d-flex align-items-center justify-content-center logoTopBFSLabel">
                                                                            <h6 class="mb-0 text-danger">
                                                                ...
                                                                <div class="col-md-6 col-lg-2">
                                                                    <div class="card border-warning h-100">
                                                                        <div class="card-header bg-warning-subtle">
                                                                            <small
                                                                                class="fw-bold text-warning">{{__('Percentage')}}</small>
                                                                        </div>
                                                                        <div
                                                                            class="card-body d-flex align-items-center justify-content-center">
                                                                                    <span
                                                                                        class="badge bg-warning-subtle text-warning fs-14">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6 col-lg-3">
                                                        <div class="card border h-100">
                                                            ...
                                                            <div
                                                                class="card-body d-flex align-items-center justify-content-center">
                                                                        <span
                                                                            class="badge bg-success-subtle text-success fs-14">
                                                                            {{$cash->reference}}
                                                                        </span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6 col-lg-3">
                                                        <div class="card border-danger h-100">
                                                            ...
                                                            <div
                                                                class="card-body d-flex align-items-center justify-content-center logoTopCashLabel">
                                                                <h6 class="mb-0 text-danger">
