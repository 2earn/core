            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 mt-3">
                        <button wire:click="refreshData" class="btn btn-primary" wire:loading.attr="disabled" wire:target="refreshData">
                            <span wire:loading.remove wire:target="refreshData">
                                <i class="ri-refresh-line me-1"></i>
                            </span>
                            <span class="spinner-border spinner-border-sm me-1" role="status" wire:loading wire:target="refreshData">
                        ...
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-body">
                                ...
                                <div class="progress mt-2" style="height: 6px;">
                                    <div class="progress-bar bg-info" role="progressbar" style="width: {{ min($expectedProgress, 100) }}%" aria-valuenow="{{ $expectedProgress }}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="avatar-sm">
                                        <span class="avatar-title bg-{{ $actualProgress >= $expectedProgress ? 'success' : 'warning' }}-subtle text-{{ $actualProgress >= $expectedProgress ? 'success' : 'warning' }} rounded-circle fs-2">
                                            <i class="ri-line-chart-line"></i>
                                        </span>
                                    </div>
                                </div>
                                <div class="progress mt-2" style="height: 6px;">
                                    <div class="progress-bar bg-{{ $actualProgress >= $expectedProgress ? 'success' : 'warning' }}" role="progressbar" style="width: {{ min($actualProgress, 100) }}%" aria-valuenow="{{ $actualProgress }}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
