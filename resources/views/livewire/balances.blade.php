                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-lg-4 text-end">
                                <div class="d-inline-flex align-items-center bg-light rounded-pill px-3 py-2">
                                    ...
                                    <select wire:model.live="perPage" class="form-select form-select-sm border-0 bg-transparent shadow-none pe-4" style="width: 70px;">
                                        ...
                                        <div class="col-md-2 text-md-end">
                                            @if($operation->modify_amount)
                                                <div class="d-flex flex-column align-items-md-end">
                                                    <span class="badge {{ $operation->modify_amount > 0 ? 'bg-success' : 'bg-danger' }} text-white px-3 py-2 fs-6">
