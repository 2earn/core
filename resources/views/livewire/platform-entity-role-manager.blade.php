<div class="container">
    ...
    <div class="row">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="card-title mb-0">{{ __('Entity Roles for') }}:
                            <strong>{{ $platform->name }}</strong></h5>
                                        ...
                                        <div class="d-flex align-items-center bg-light p-2 rounded">
                                            <div class="avatar-xs me-2">
                                                <span class="avatar-title rounded-circle bg-soft-success text-success">
                                                    {{ substr(getUserDisplayedNameFromId($selectedUser->id), 0, 1) }}
                                                </span>
                                            </div>
                                            <div class="flex-grow-1">
        ...
        <div class="col-12">
            <a href="{{ route('platform_index', app()->getLocale()) }}" class="btn btn-secondary">
                <i class="ri-arrow-left-line me-1"></i>{{ __('Back to Platforms') }}
            </a>
        </div>
    </div>
</div>
