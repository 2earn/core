...
<div>
    ...
    @section('content')
                            ...
                            <div class="col col-lg border-end">
                                <div class="py-4 px-3">
                                    ...
                                    <p class="text-muted mb-0"><i class="ri-building-line align-bottom"></i>
                                        {{ number_format(getAdminCash()[0], 2) }} <span class="ms-2"><i
                                                class="ri-map-pin-2-line align-bottom"></i>
                                            {{ number_format(getUserListCards()[0] - getAdminCash()[0], 2) }}</span></p>
                                </div>
                            </div><!-- end col -->
                            <div class="col col-lg border-end">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table id="users-list" class="table nowrap dt-responsive align-middle table-hover table-bordered"
                            style="width:100%">
        ...
        <div class="modal fade" id="AddCash" tabindex="-1" aria-labelledby="exampleModalgridLabel"
            aria-modal="true">
                            ...
                            <div class="row g-3">
                                <div class="col-xxl-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><img id="userlist-country" alt=""
        ...
        <script>
            ...
            $(document).on("click", ".cb", function() {
                ...
                window.url =
                    "{{ route('API_UserBalances_list', ['locale' => app()->getLocale(), 'idUser' => 'idUser1', 'idAmounts' => 'idamount1']) }}";
                ...
                $(document).ready(function() {
                    $.getJSON(window.url, function(data) {
                        ...
                        data); // Appeler la fonction pour créer ou mettre à jour le DataTable avec les nouvelles données
                    });
                });
            });
        ...
        <script>
            ...
            $(document).on("click", ".sh", function() {
                ...
                window.url =
                    "{{ route('API_SharesSolde_list', ['locale' => app()->getLocale(), 'idUser' => 'idUser1']) }}";
                window.url = window.url.replace('idUser1', reciver);
                $(document).ready(function() {
                    $.getJSON(window.url, function(data) {
                        createOrUpdateDataTablesh(
                        data); // Appeler la fonction pour créer ou mettre à jour le DataTable avec les nouvelles données
                    });
                });
            });
                                ...
                                <table class="table nowrap dt-responsive align-middle table-hover table-bordered"
                                    ...
                                    <thead class="table-light">
                                        <tr class="head2earn  tabHeader2earn">
                                            ...
                                            <th style=" border: none;text-align: center; ">{{ __('current_earnings') }}
                                            </th>
