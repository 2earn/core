                    ...
                    <div class="row">
                        @foreach($setting_notif->where('type', 'b') as $key => $setting)
                            @if($setting->typeNotification == 'm')
                                <div class="form-check form-switch {{ $setting->payer == 0 ? 'toggle-checkboxFree' : 'toggle-checkboxPay' }} m-2 col-12 mb-3" dir="ltr">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-4">
                            <div class="d-flex justify-content-center gap-2 flex-wrap">
                                ...
                                <div class="alert alert-danger material-shadow alert-dismissible alert-solid alert-label-icon fade show mb-0"
