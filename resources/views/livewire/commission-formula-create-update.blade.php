                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">{{ __('Ending commission percentage (must be greater than initial)') }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">{{ __('Optional detailed description of when and how this formula should be used.') }}</div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled text-muted mb-3">
                                <li><i class="ri-arrow-right-s-line text-success"></i> {{ __('Initial commission must be between 0% and 100%') }}</li>
                                <li><i class="ri-arrow-right-s-line text-success"></i> {{ __('Final commission must be greater than initial') }}</li>
                                <li><i class="ri-arrow-right-s-line text-success"></i> {{ __('Both values support 2 decimal places') }}</li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <h6 class="text-muted mb-2">{{ __('Best Practices') }}</h6>
                            <ul class="list-unstyled text-muted mb-3">
                                <li><i class="ri-arrow-right-s-line text-info"></i> {{ __('Use descriptive names (e.g., "Premium Partner Plan")') }}</li>
                                <li><i class="ri-arrow-right-s-line text-info"></i> {{ __('Add detailed descriptions for clarity') }}</li>
                                <li><i class="ri-arrow-right-s-line text-info"></i> {{ __('Set inactive when not in use') }}</li>
                            </ul>
                        </div>
                    </div>
                    <div class="alert alert-warning border-0 mb-0" role="alert">
                        <i class="ri-error-warning-line align-middle me-1"></i>
                        <strong>{{ __('Note:') }}</strong> {{ __('All fields marked with') }} <span class="text-danger">*</span> {{ __('are required.') }}
                    </div>
                </div>
            </div>
        </div>
