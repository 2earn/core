                            ...
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <div>
                                            <span
                                                class="badge bg-primary-subtle text-primary fs-6">#{{$payment->id}}</span>
                                        </div>
                                        <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if($payment->isValidated())
                                            <br>
                                            <small
                                                class="text-muted">{{__('Validated')}} {{$payment->validated_at?->format('Y-m-d')}}</small>
                                        @elseif($payment->isRejected())
                                            <br>
                                            <small
                                                class="text-muted">{{__('Rejected')}} {{$payment->rejected_at?->format('Y-m-d')}}</small>
                                        @endif
                                    </div>
                                </div>
