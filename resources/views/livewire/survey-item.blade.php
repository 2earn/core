                        ...
                        <div class="card-body p-3">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    ...
                                    <span class="badge {{ $survey->enabled ? 'bg-success' : 'bg-danger' }} px-2 py-1">
                                        {{__($survey->enabled ? 'True' : 'False')}}
                                    </span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <span><i class="ri-broadcast-line me-2"></i>{{__('Published')}}</span>
                                    <span class="badge {{ $survey->published ? 'bg-success' : 'bg-danger' }} px-2 py-1">
                                        {{__($survey->published ? 'True' : 'False')}}
                                    </span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <span><i class="ri-edit-box-line me-2"></i>{{__('Updatable')}}</span>
                                    <span class="badge {{ $survey->updatable ? 'bg-success' : 'bg-danger' }} px-2 py-1">
    ...
    @if($currentRouteName=="surveys_show")
        <div class="card">
            ...
            <div class="card-body row">
                ...
                @if($survey->isLikable())
                    <div class="col-12">
                        <h6 class="text-info mb-3"><i class="ri-user-heart-line me-2"></i>{{__('Users who liked')}}</h6>
                        @php
