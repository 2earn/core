                            ...
                            <div class="col-lg-5">
                                <div class="text-center mt-4 mb-5">
                                    <div class="py-3 px-2 d-inline-block" id="logo-tour">
                                        <img src="{{ Vite::asset('resources/images/logo-dark.png') }}" class="card-logo card-logo-dark" alt="logo"
                                            height="17">
                                        <img src="{{ Vite::asset('resources/images/logo-light.png') }}" class="card-logo card-logo-light" alt="logo"
                                            height="17">
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card border shadow-none">
                                            <div class="card-body text-center">
                                                ...
                                                <h5>Get Product</h5>
                                                <p class="text-muted mb-0"> in to continue to Velzon.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end col -->
