                    ...
                    <div class="live-preview">
                        <nav id="navbar-example" class="navbar navbar-light bg-light px-3">
                            <a class="navbar-brand" href="#">
                                <img src="{{ Vite::asset('resources/images/logo-dark.png') }}" class="card-logo card-logo-dark" alt="logo dark"
                                    height="14">
                            ...
                            <div class="col-xxl-3">
                                <nav id="navbar-examplenested" class="navbar navbar-light bg-light flex-column">
                                    <a class="navbar-brand mb-2" href="#">
                                        <img src="{{ Vite::asset('resources/images/logo-dark.png') }}" class="card-logo card-logo-dark"
                                            alt="logo dark" height="15">
                                        <img src="{{ Vite::asset('resources/images/logo-light.png') }}" class="card-logo card-logo-light"
