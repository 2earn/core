                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-2">
                    <div class="col">
                        <a data-name="home" href="{{route('home',app()->getLocale(),false)}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='home'? 'active bg-light' : ''}}"
                           role="button">
                    ...
                    <div class="col">
                        <a data-name="account" href="{{route('account',app()->getLocale(),false )}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='account'? 'active bg-light' : ''}}"
                           role="button">
                    ...
                    <div class="col">
                        <a data-name="contacts" href="{{route('contacts',app()->getLocale(),false)}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='contacts'? 'active bg-light' : ''}}"
                           role="button">
                    ...
                    <div class="col">
                        <a href="{{route($sidebarBusinessArray[0], app()->getLocale(),false)}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarBusinessArray[0]? 'active bg-light' : ''}}">
                    ...
                    <div class="col">
                        <a href="{{route($sidebarBusinessArray[1], app()->getLocale(),false)}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarBusinessArray[1]? 'active bg-light' : ''}}">
                    ...
                    <div class="col">
                        <a href="{{route($sidebarBusinessArray[2], app()->getLocale(),false)}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarBusinessArray[2]? 'active bg-light' : ''}}">
                    ...
                    <div class="col">
                        <a href="{{route($sidebarBusinessArray[3], app()->getLocale(),false)}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarBusinessArray[3]? 'active bg-light' : ''}}">
                    ...
                    <div class="col">
                        <a href="{{route($sidebarSavingsArray[0], app()->getLocale(),false)}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarSavingsArray[0]? 'active bg-light' : ''}}">
                    ...
                    <div class="col">
                        <a href="{{route($sidebarSavingsArray[1], app()->getLocale(),false)}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarSavingsArray[1]? 'active bg-light' : ''}}">
                    ...
                    <div class="col">
                        <a href="{{route($sidebarBiographyArray[8], app()->getLocale(),false)}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarBiographyArray[8]? 'active bg-light' : ''}}">
                    ...
                    <div class="col">
                        <a href="{{route('financial_transaction',app()->getLocale(),false)}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='financial_transaction'? 'active bg-light' : ''}}"
                           role="button">
                    ...
                    <div class="col">
                        <a href="{{route('hobbies',app()->getLocale(),false )}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='hobbies'? 'active bg-light' : ''}}"
                           role="button">
                    ...
                    <div class="col">
                        <a href="{{route('news_index',app()->getLocale(),false )}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='news_index'? 'active bg-light' : ''}}"
                           role="button">
                    ...
                    <div class="col">
                        <a href="{{route('event_index',app()->getLocale(),false )}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='event_index'? 'active bg-light' : ''}}"
                           role="button">
                    ...
                    @if(\Core\Models\Platform::canCheckDeals(auth()->user()->id))
                        <div class="col">
                            <a href="{{route('deals_index',app()->getLocale(),false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='deals_index'? 'active bg-light' : ''}}"
                               role="button">
                    ...
                    <div class="col">
                        <a href="{{route('coupon_injector_runner',app()->getLocale(),false )}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='coupon_injector_runner'? 'active bg-light' : ''}}"
                           role="button">
                    ...
                    <div class="col">
                        <a href="{{route('settlement_tracking',app()->getLocale(),false )}}"
                           class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='settlement_tracking'? 'active bg-light' : ''}}"
                           role="button">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-2">
                        <div class="col">
                            <a href="{{route('business_sector_index',app()->getLocale(),false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='business_sector_index'? 'active bg-light' : ''}}"
                               role="button">
                        ...
                        <div class="col">
                            <a href="{{route('platform_index',['locale'=>app()->getLocale()],false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='platform_index'? 'active bg-light' : ''}}"
                               role="button">
                        ...
                        <div class="col">
                            <a href="{{route('coupon_index',app()->getLocale(),false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='coupon_index'? 'active bg-light' : ''}}"
                               role="button">
                        ...
                        <div class="col">
                            <a href="{{route('coupon_injector_index',app()->getLocale(),false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='coupon_injector_index'? 'active bg-light' : ''}}"
                               role="button">
                        ...
                        <div class="col">
                            <a href="{{route('orders_index',['locale'=>app()->getLocale()],false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='orders_index'? 'active bg-light' : ''}}"
                               role="button">
                        ...
                        <div class="col">
                            <a href="{{route('user_list',['locale'=>app()->getLocale()],false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='user_list'? 'active bg-light' : ''}}"
                               role="button">
                        ...
                        <div class="col">
                            <a href="{{route('items_index',['locale'=>app()->getLocale()],false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='items_index'? 'active bg-light' : ''}}"
                               role="button">
                        ...
                        <div class="col">
                            <a href="{{route('target_index',['locale'=>app()->getLocale(),'idSurvey'=>request()->route("idSurvey")],false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='target_index'? 'active bg-light' : ''}}"
                               role="button">
                        ...
                        <div class="col">
                            <a href="{{route('surveys_index',['locale'=>app()->getLocale()],false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='surveys_index'? 'active bg-light' : ''}}"
                               role="button">
                                <i class="ri-pushpin-fill me-2"></i>
                        ...
                        <div class="col">
                            <a href="{{route('hashtags_index',['locale'=>app()->getLocale()],false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='hashtags_index'? 'active bg-light' : ''}}"
                               role="button">
                        ...
                        <div class="col">
                            <a href="{{route('balances_index',['locale'=>app()->getLocale()],false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='balances_index'? 'active bg-light' : ''}}"
                               role="button">
                        ...
                        <div class="col">
                            <a href="{{route('balances_categories_index',['locale'=>app()->getLocale()],false )}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName=='balances_categories_index'? 'active bg-light' : ''}}"
                               role="button">
                        ...
                        <div class="col">
                            <a href="{{route($sidebarRoleArray[0], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarRoleArray[0]? 'active bg-light' : ''}}">
                        ...
                        <div class="col">
                            <a href="{{route($sidebarRoleArray[1], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarRoleArray[1]? 'active bg-light' : ''}}">
                        ...
                        <div class="col">
                            <a href="{{route($sidebarDashboardsArray[0], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarDashboardsArray[0]? 'active bg-light' : ''}}">
                        ...
                        <div class="col">
                            <a href="{{route($sidebarDashboardsArray[1], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarDashboardsArray[1]? 'active bg-light' : ''}}">
                        ...
                        <div class="col">
                            <a href="{{route($sidebarDashboardsArray[2], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarDashboardsArray[2]? 'active bg-light' : ''}}">
                        ...
                        <div class="col">
                            <a href="{{route($sidebarShareSoldArray[0], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarShareSoldArray[0]? 'active bg-light' : ''}}">
                        ...
                        <div class="col">
                            <a href="{{route($sidebarShareSoldArray[1], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarShareSoldArray[1]? 'active bg-light' : ''}}">
                        ...
                        <div class="col">
                            <a href="{{route($sidebarShareSoldArray[2], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarShareSoldArray[2]? 'active bg-light' : ''}}">
                        ...
                        <div class="col">
                            <a href="{{route($sidebarRequestsArray[0], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarRequestsArray[0]? 'active bg-light' : ''}}">
                        ...
                        <div class="col">
                            <a href="{{route($sidebarRequestsArray[1], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarRequestsArray[1]? 'active bg-light' : ''}}">
                                <i class="ri-user-2-fill me-2"></i>
                        ...
                        <div class="col">
                            <a href="{{route($sidebarRequestsArray[2], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarRequestsArray[2]? 'active bg-light' : ''}}">
                        ...
                        <div class="col">
                            <a href="{{route($sidebarTranslateArray[0], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarTranslateArray[0]? 'active bg-light' : ''}}">
                        ...
                        <div class="col">
                            <a href="{{route($sidebarTranslateArray[1], app()->getLocale(),false)}}"
                               class="nav-link menu-link p-2 rounded hover-bg {{$currentRouteName==$sidebarTranslateArray[1]? 'active bg-light' : ''}}">
