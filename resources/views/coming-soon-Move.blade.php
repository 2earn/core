                    ...
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 pt-4 mb-4">
                            <div class="mb-sm-5 pb-sm-4 pb-5">
                                <img src="{{Vite::asset('resources/images/Move2earn Icon.png')}}" alt="" height="120" class="move-animation">
                            </div>
                            <div class="mb-5">
...
{{--                                </div>--}}
{{--                                <a href="{{route('main',app()->getLocale())}}" class="btn btn-success" type="button" >Home<i class="ri-send-plane-2-fill align-bottom ms-2"></i></a>--}}
