<footer class="footer modern-footer {{$pageName}} mt-auto">
    <div class="footer-wave-container">
        <svg class="footer-wave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                        ...
                        <div class="row">
                            <div class="col-lg-10 offset-lg-1">
                                <p class="text-center mb-0 lh-lg">
                                    <a href="{{route('home',app()->getLocale())}}" class="footer-link-highlight">
                                        2Earn.cash
                                    </a>
                                    <span class="d-inline-block mx-1">{{ __('has been accepted into') }}</span>
                                    <a href="https://www.fastercapital.com" class="footer-link-highlight" target="_blank" rel="noopener">
                                        {{ __('FasterCapital')}}
                                    </a>{{__("'s") }}
                                    <a href="https://fastercapital.com/incubation-pending/2earncash.html" class="footer-link-highlight" target="_blank" rel="noopener">
                                        {{ __('Raise Capital') }}
                                    </a>
