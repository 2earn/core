@if(Session::has('success'))
    <div class="col-12 text-success  alert alert-success alert-top-border alert-dismissible fade show material-shadow"
         role="alert">
...
@if(Session::has('warning'))
    <div class="col-12 text-warning  alert alert-warning alert-top-border alert-dismissible fade show material-shadow"
         role="alert">
...
@endif
@if(Session::has('info'))
    <div class="col-12 text-info  alert alert-info alert-top-border alert-dismissible fade show material-shadow"
         role="alert">
...
@endif
@if(Session::has('from'))
    <div class="col-12 text-warning  alert alert-warning mx-1" role="alert">
