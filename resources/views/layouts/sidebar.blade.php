        ...
        <div id="scrollbar">
            <div class="container-fluid">
                ...
                @php
                    ...
                    $otherAdmin=['business_sector_index','business_sector_create_update'];
                    $adminTab=array_merge($sidebarRequestsArray,$sidebarTranslateArray,$sidebarShareSoldArray,$sidebarDashboardsArray,$sidebarRoleArray,$otherAdmin)
                @endphp
                <div class="card-body">
                    <ul class="nav nav-tabs nav-justified nav-border-top nav-border-top-info mb-3" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{!in_array($currentRouteName, $adminTab)? 'active' : ''}}" data-bs-toggle="tab" href="#nav-border-justified-home" role="tab"
                               aria-selected="true">
                                <i class="ri-home-5-line align-middle me-1"></i> {{__('User')}}
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{in_array($currentRouteName, $adminTab)? 'active' : ''}}" data-bs-toggle="tab" href="#nav-border-justified-profile" role="tab"
                    ...
                    <div class="tab-content text-muted">
                        <div class="tab-pane {{!in_array($currentRouteName, $adminTab)? 'active show' : ''}} " id="nav-border-justified-home" role="tabpanel">
                        ...
                        <div class="tab-pane {{in_array($currentRouteName, $adminTab)? 'active show' : ''}} " id="nav-border-justified-profile" role="tabpanel">
                            <ul class="navbar-nav" id="navbar-nav">
