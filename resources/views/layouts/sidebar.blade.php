        ...
        <div id="scrollbar">
            <div class="container-fluid">
                ...
                @php
                    ...
                    $otherAdmin=['items_index','target_create_update',
                    'countries_management','stat_countrie','user_list',
                    'balances_index'];
                    $adminTab=array_merge($sidebarRequestsArray,$orderArray,$surveysArray,$sidebarTranslateArray,$sidebarShareSoldArray,$sidebarDashboardsArray,$sidebarRoleArray,$otherAdmin,$businessSectorArray,$couponArray,$platformArray)
                @endphp
                <div class="card-body">
