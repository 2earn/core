...
var url = "/assets/json/";
var allmemberlist = '';
// var nurl ='C:\xampp\htdocs\modern\public\assets\json\team-member-list.json';
var nurl = "{{ URL::asset('assets/json/team-member-list.json') }}";
...
function loadTeamData(datas) {
    ...
    Array.from(datas).forEach(function (teamData, index) {
        ...
        var isUserProfile = teamData.memberImg ? '<img src="http://localhost:8000/assets/images/logo-sm.png" alt="" class="member-img img-fluid d-block rounded-circle" />'
