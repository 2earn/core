...
<html dir="<?php echo e(config('app.available_locales')[app()->getLocale()]['direction']); ?>"
      ...
      data-sidebar="light" data-sidebar-size="sm-hover" data-sidebar-image="none" data-preloader="disable"
      id="HTMLMain"
>
<head>
    <meta charset="utf-8"/>
...
} elseif ($_instance->childHasBeenRendered('iDqNEX0')) {
    $componentId = $_instance->getRenderedChildComponentId('iDqNEX0');
    $componentTag = $_instance->getRenderedChildComponentTagName('iDqNEX0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iDqNEX0');
} else {
    $response = \Livewire\Livewire::mount('top-bar', []);
    $html = $response->html();
    $_instance->logRenderedChild('iDqNEX0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
