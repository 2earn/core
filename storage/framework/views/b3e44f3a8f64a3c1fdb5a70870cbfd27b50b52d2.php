                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="index" class="d-block">
                                                    <img src="<?php echo e(URL::asset('assets/images/2earn.png')); ?>"
                                                         alt="2earn.cash">
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                ...
                                                <div id="qoutescarouselIndicators" class="carousel slide"
                                                    ...
                                                    <div class="carousel-inner text-center text-white-50 pb-5">
                                                        ...
                                                        <div class="carousel-item">
                                                            <img src="<?php echo e(asset('assets/images/Move2earn Icon.png')); ?>"
                                                        ...
                                                        <div class="carousel-item">
                                                            <img src="<?php echo e(asset('assets/images/icon-learn.png')); ?>"
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-primary"> <?php echo e(__('continueTo2earn')); ?> </p>
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="mt-4">
                                                    <button onclick="functionLogin()"
                                                            ...
                                                            type="button" id="btn"><?php echo e(__('Sign in')); ?>
...
<?php /**PATH C:\Users\ghazi\Documents\GitHub\2earnprod\resources\views/livewire/login.blade.php ENDPATH**/ ?>