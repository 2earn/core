...
} elseif ($_instance->childHasBeenRendered('8sMTAMp')) {
    $componentId = $_instance->getRenderedChildComponentId('8sMTAMp');
    $componentTag = $_instance->getRenderedChildComponentTagName('8sMTAMp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8sMTAMp');
} else {
    $response = \Livewire\Livewire::mount('top-bar', []);
    $html = $response->html();
    $_instance->logRenderedChild('8sMTAMp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\wamp64\www\2earn\resources\views/layouts/master.blade.php ENDPATH**/ ?>