                ...
                <div class="col-lg-12">
                    <div class="text-center mt-sm-5 pt-4 mb-4">
                        ...
                        <div>
                            ...
                            <a href="<?php echo e(route('main',app()->getLocale())); ?>" class="btn btn-success" type="button" >Home<i class="ri-send-plane-2-fill align-bottom ms-2"></i></a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\modern\resources\views/pages-coming-soon.blade.php ENDPATH**/ ?>