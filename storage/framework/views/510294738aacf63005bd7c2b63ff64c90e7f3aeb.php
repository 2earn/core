...
align-items: center;background-color: black;position: fixed;top: 0px;left: 0px;z-index: 9999;width: 100%;height: 100%;opacity: 0.75">
    ...
    <div class="row">
        ...
        <!-- Modal -->
        <div wire:ignore.self class="modal fade" id="AddContactNumberModel"
    ...
    <script data-tubolinks-eval=false>
        ...
        window.addEventListener('PreAddNumber', event => {
            Swal.fire({
                ...
                html: '<?php echo e(__('We_will_send')); ?>' + ' ' + event.detail.FullNumber + '<br>' + '<?php echo e(__('Your OTP Code')); ?>',
...
<?php /**PATH /var/www/vhosts/2earn.cash/dev.2earn.cash/resources/views/livewire/contact-number.blade.php ENDPATH**/ ?>