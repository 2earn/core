            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-justified mb-3" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#me_others" role="tab" aria-selected="true">
                                ...
                                <?php if($requestOutAccepted>0): ?>
                                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" >
                                        ...
                                        <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-success"> <?php echo e($requestOutAccepted); ?></span>
                                    </button>
                                ...
                                <?php if($requestOutRefused>0): ?>
                                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" >
                                        ...
                                        <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger"><?php echo e($requestOutRefused); ?></span>
                                    </button>
                                <?php endif; ?>
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#others_me" role="tab" aria-selected="true">
                                ...
                                <?php if($requestInOpen>0): ?>
                                    ...
                                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" >
                                        ...
                                        <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-primary">  <?php echo e($requestInOpen); ?></span>
                                    </button>
                                <?php endif; ?>
