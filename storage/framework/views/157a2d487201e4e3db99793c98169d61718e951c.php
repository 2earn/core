...
} elseif ($_instance->childHasBeenRendered('l2417986694-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2417986694-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2417986694-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2417986694-0');
} else {
    $response = \Livewire\Livewire::mount('identification-check', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2417986694-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
} elseif ($_instance->childHasBeenRendered('l2417986694-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2417986694-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2417986694-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2417986694-1');
} else {
    $response = \Livewire\Livewire::mount('edit-phone-number', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2417986694-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\ghazi\Documents\GitHub\2earnprod\resources\views/livewire/account.blade.php ENDPATH**/ ?>