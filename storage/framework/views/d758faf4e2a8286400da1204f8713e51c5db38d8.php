...
} elseif ($_instance->childHasBeenRendered('HjMZnQa')) {
    $componentId = $_instance->getRenderedChildComponentId('HjMZnQa');
    $componentTag = $_instance->getRenderedChildComponentTagName('HjMZnQa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HjMZnQa');
} else {
    $response = \Livewire\Livewire::mount('top-bar', []);
    $html = $response->html();
    $_instance->logRenderedChild('HjMZnQa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /var/www/vhosts/2earn.cash/httpdocs/resources/views/layouts/master.blade.php ENDPATH**/ ?>