...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> <?php echo e(__('Stat By Countries')); ?> <?php $__env->endSlot(); ?>
                        ...
                        <div class="col-12">
                            <div class="card card-height-100">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Countries Statistics</h4>
        ...
        anychart.data.loadJsonFile(
            ...
            function (data) {
                ...
                function changeContent(ids) {
                    ...
                    areaChart.data([
                        ((bfs * 100) / getDataSum('BFS')).toFixed(2),
                        100
                    ]);
                    areaChart
                        .label()
                        .text(((bfs * 100) / getDataSum('BFS')).toFixed(2) + '%');

                    houseSeatsChart.data([
                        ((discount * 100) / getDataSum('DISCOUNT_BALANCE')).toFixed(2),
                        100
                    ]);
                    houseSeatsChart
                        .label()
                ...
                function drawMap() {
                    ...
                    map
                        ...
                        .padding([10, 0, 10, 0])
                        .text(
                            'Countries Statistics<br/>' +
                            '<span  style="color:#929292; font-size: 12px;">2Earn.cash Concept</span>'
                        );
...
<script>
    anychart.onDocumentReady(function () {
            ...
            // https://cdn.anychart.com/samples/maps-in-dashboard/states-of-united-states-dashboard-with-multi-select/data.json
            anychart.data.loadJsonFile(
                "<?php echo e(route('API_sankey',app()->getLocale())); ?>",
                function (data) {
        var chart = anychart.sankey();
            ...
            // set chart's data
            chart.data(data); // eslint-disable-line no-undef
...
<?php /**PATH C:\Users\ghazi\Documents\GitHub\2earnprod\resources\views/livewire/stat-countrie.blade.php ENDPATH**/ ?>