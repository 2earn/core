...
} elseif ($_instance->childHasBeenRendered('l3198268799-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3198268799-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3198268799-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3198268799-0');
} else {
    $response = \Livewire\Livewire::mount('identification-check', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3198268799-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
} elseif ($_instance->childHasBeenRendered('l3198268799-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3198268799-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3198268799-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3198268799-1');
} else {
    $response = \Livewire\Livewire::mount('edit-phone-number', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3198268799-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\wamp64\www\2earn\resources\views/livewire/account.blade.php ENDPATH**/ ?>