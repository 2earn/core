                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                            ...
                            <img src="<?php if(file_exists('uploads/profiles/profile-image-' . $user['idUser'] . '.png')): ?> <?php echo e(URL::asset('uploads/profiles/profile-image-'.$user['idUser'].'.png')); ?><?php else: ?><?php echo e(URL::asset('uploads/profiles/default.png')); ?> <?php endif; ?>"
                            ...
                            <div class="avatar-xs p-0 rounded-circle profile-photo-edit">
                                <input id="profile-img-file-input" type="file" class="profile-img-file-input"  wire:model="imageProfil">
                        ...
                        <div class="form-check form-switch" dir="ltr">
                            <input wire:model.defer="user.is_public" type="checkbox" class="form-check-input" id="customSwitchsizesm" checked="">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="flex-grow-1">
                            <h5 class="card-title mb-0">Profil type</h5>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="firstnameInput" class="form-label">
                                                اللقب</label>
                                            <input  wire:model.defer="usermetta_info.arLastName" type="text" class="form-control" id="firstnameInput"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="lastnameInput" class="form-label">
                                                الاسم</label>
                                            <input wire:model.defer="usermetta_info.arFirstName" type="text" class="form-control" id="lastnameInput"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id=""
                                                   wire:model.defer="usermetta_info.enLastName"  placeholder="Enter your firstname" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input readonly wire:model.defer="numberActif" type="text" class="form-control inputtest" aria-label=""
                                                       placeholder="Enter your phone number">
                                                <a  href="<?php echo e(route('ContactNumber', app()->getLocale())); ?>" id="update_tel" style="cursor: pointer;" class="btn btn-primary" type="button">
                                                    add
                                                </a>
                                             </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input disabled  wire:model.defer="user.email" type="email" class="form-control"
                                                       name="email" placeholder="Enter your email">
                                                <button data-bs-toggle="modal" data-bs-target="#modalMail" class="btn btn-primary" type="button">add</button>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-step form-control">
                                                ...
                                                <input  wire:model.defer="usermetta_info.childrenCount" type="number" class="product-quantity form-control" value="2"
                                                       min="0"
                                                       max="100">
                                ...
                                <!--end col-->
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select mb-3" aria-label=" "  wire:model.defer="usermetta_info.personaltitle">
                                                <option value="">-------</option>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select mb-3" aria-label=" "  wire:model.defer="usermetta_info.gender">
                                                <<option value="">-------</option>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select mb-3" aria-label=" "  wire:model.defer="usermetta_info.idLanguage">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select mb-3" aria-label=" "  wire:model.defer="usermetta_info.idState">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input wire:model.defer="countryUser" type="text" class="form-control" id="countryInput"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" minlength="5" maxlength="50" wire:model.defer="usermetta_info.nationalID"
                                                   id="zipcodeInput" placeholder="Enter CIN"  >
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-12">
                                        <div class="mb-3 pb-2">
                                            ...
                                            <textarea wire:model.defer="usermetta_info.adresse" class="form-control" id="exampleFormControlTextarea"
                                            ...
                                            <?php else: ?>
                                                <div x-data="{ open: false }">
                                                    <button x-show="!open" type="button" @click="open = true"
                                                            class="btn btn-secondary ps-5 pe-5" id="reject"><?php echo e(__('Reject')); ?></button>
                                                    ...
                                                    <button type="button" x-show="open" wire:click="reject" class="btn btn-secondary ps-5 pe-5"
                        ...
                        <div class="tab-pane" id="changePassword" role="tabpanel">
                            <form action="">
                                <div class="row g-2">
                                    <div class="col-lg-4">
                                        <div>
                                            <label for="oldpasswordInput" class="form-label"><?php echo e(__('Current Password')); ?></label>
                                            <input wire:model.defer="oldPassword" type="password" class="form-control" id="oldpasswordInput"
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            <label for="newpasswordInput" class="form-label"><?php echo e(__('New Password')); ?></label>
                                            <input wire:model.defer="newPassword" type="password" class="form-control" id="newpasswordInput"
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            <label for="confirmpasswordInput" class="form-label"><?php echo e(__('New Confirm Password')); ?></label>
                                            <input wire:model.defer="confirmedPassword" type="password" class="form-control" id="confirmpasswordInput"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="text-end">
                                            <button  onclick="ConfirmChangePass()" type="button" class="btn btn-success">Change
                                                Password
                                            </button>
                                        </div>
                                    </div>
...
} elseif ($_instance->childHasBeenRendered('l1187095104-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1187095104-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1187095104-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1187095104-0');
} else {
    $response = \Livewire\Livewire::mount('identification-check', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1187095104-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
} elseif ($_instance->childHasBeenRendered('l1187095104-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1187095104-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1187095104-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1187095104-1');
} else {
    $response = \Livewire\Livewire::mount('edit-phone-number', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1187095104-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <div class="row g-3">
                            <div class="col-xxl-12">
                                <div>
                                    ...
                                    <input type="email" wire:model.defer="user.email" class="form-control" id="inputEmail" placeholder="<?php echo e(__('your_new_mail')); ?>">
                                </div>
                            </div><!--end col-->
                            <div class="col-lg-12">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal"><?php echo e(__('Close')); ?></button>
                                    <button type="button" id="validateMail" class="btn btn-primary"><?php echo e(__('Save_changes')); ?></button>
                                </div>
                            </div><!--end col-->
                        </div><!--end row-->
                    </form>
...
<?php /**PATH /var/www/vhosts/2earn.cash/dev.2earn.cash/resources/views/livewire/account.blade.php ENDPATH**/ ?>