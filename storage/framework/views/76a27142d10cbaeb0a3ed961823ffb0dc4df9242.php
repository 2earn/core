            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="col-lg-4">
                            <h6 class="fw-semibold"><?php echo e(__('operation')); ?></h6>
                            <select class="bfs_operation_multiple" name="states[]" multiple="multiple">
                            </select>
                        </div>
                    </div>
                    <div class="card-body">
...
<?php /**PATH /var/www/vhosts/2earn.cash/dev.2earn.cash/resources/views/livewire/user-balance-b-f-s.blade.php ENDPATH**/ ?>