    ...
    width: 120px;">
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        <button class="btn btn-outline-secondary d-none" type="button" id="simulate1"><?php echo e(__('simulate')); ?></button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalgridLabel"><?php echo e(__('Transfert')); ?></h5>
...
<?php /**PATH /var/www/vhosts/2earn.cash/httpdocs/resources/views/livewire/user-balance-c-b.blade.php ENDPATH**/ ?>