...
<?php $__env->startComponent('components.breadcrumb'); ?>
    <?php $__env->slot('title'); ?> <?php echo e(__('Privacy')); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="bg-warning-subtle position-relative">
        <div class="card-body p-5">
            <div class="text-center">
                <h3>Privacy Policy for 2earn.cash</h3>
                <p class="mb-0 text-muted"><strong>Last Updated:</strong> February 29, 2024</p>
            </div>
        </div>
    ...
    <div class="card-body p-4">
        <div class="d-flex">
            ...
            <div class="flex-grow-1">
                ...
                <p class="text-muted">At 2earn.cash, accessible at 2earn.cash, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Website Name and how we use it.</p>
                <p class="text-muted">If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us through email at support@2earn.cash</p>
...
<?php /**PATH /var/www/vhosts/2earn.cash/httpdocs/resources/views/livewire/privacy.blade.php ENDPATH**/ ?>