<div>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('title'); ?> <?php echo e(__('Home')); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="row">
                        ...
                        <div class="flex-shrink-0">
                            <h5 class="text-success fs-14 mb-0">
                                ...
                                <?php if($cashBalance - $arraySoldeD[0] > 0): ?>
                                    <p class="text-success" style="max-height: 5px">+<?php echo e($cashBalance - $arraySoldeD[0]); ?>

                                        <i class="ri-arrow-right-up-line fs-13 align-middle"></i></p>
                                <?php elseif($cashBalance - $arraySoldeD[0] < 0): ?>
                                    <p class="text-danger" style="max-height: 5px"><?php echo e($cashBalance - $arraySoldeD[0]); ?> <i
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            ...
                            <h3 class="mb-4 fs-22 fw-semibold ff-secondary">$<span class="counter-value"
                                                                                   data-target="<?php echo e((int)$cashBalance); ?>">0</span>
                            ...
                            <a href="<?php echo e(route('user_balance_cb' , app()->getLocale() )); ?> "
                               class="text-decoration-underline"><?php echo e(__('see_details')); ?></a>
                        </div>
                ...
                <div class="card-body">
                            ...
                            <h5 class="text-success fs-14 mb-0">
                                <?php if($balanceForSopping - $arraySoldeD[1] > 0): ?>
                                    <p class="text-success" style="max-height: 5px">
                                        +<?php echo e($balanceForSopping - $arraySoldeD[1]); ?> <i
                                            class="ri-arrow-right-up-line fs-13 align-middle"></i></p>
                                <?php elseif($balanceForSopping - $arraySoldeD[1] < 0): ?>
                                    <p class="text-danger"
                                       style="max-height: 5px"><?php echo e($balanceForSopping - $arraySoldeD[1]); ?> <i
                                            class="ri-arrow-right-down-line fs-13 align-middle"></i></p>
                                <?php endif; ?>
                            </h5>
                        </div>
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            ...
                            <h3 class="mb-4 fs-22 fw-semibold ff-secondary">$<span class="counter-value"
                                                                                   data-target="<?php echo e((int)$balanceForSopping); ?>">0</span><small
                        ...
                        <div class="avatar-sm flex-shrink-0">
                            <lord-icon
                                src="<?php echo e(URL::asset('assets/icons/146-basket-trolley-shopping-card-gradient-edited.json')); ?>"
                                trigger="loop"
                                colors="primary:#464fed,secondary:#bc34b6" style="width:55px;height:55px">
                            </lord-icon>
                        </div>
                ...
                <div class="card-body">
                        ...
                        <div class="flex-shrink-0">
                            <h5 class="text-success fs-14 mb-0">
                                ...
                                <?php if($discountBalance - $arraySoldeD[2] > 0): ?>
                                    <p class="text-success" style="max-height: 5px">
                                        +<?php echo e($discountBalance - $arraySoldeD[2]); ?> <i
                                            class="ri-arrow-right-up-line fs-13 align-middle"></i></p>
                                <?php elseif($discountBalance - $arraySoldeD[2] < 0): ?>
                                    <p class="text-danger"
                                       style="max-height: 5px"><?php echo e($discountBalance - $arraySoldeD[2]); ?> <i
                                            class="ri-arrow-right-down-line fs-13 align-middle"></i></p>
                                <?php endif; ?>
                            </h5>
                        </div>
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            ...
                            <h4 class="mb-4 fs-22 fw-semibold ff-secondary"><?php echo e(__('DPC')); ?><span class="counter-value"
                                                                                               data-target="<?php echo e((int)$discountBalance); ?>">0</span><small
                                    class="text-muted fs-13">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            ...
                            <a href="<?php echo e(route('user_balance_sms' , app()->getLocale() )); ?> "
                               class="text-decoration-underline"><?php echo e(__('see_details')); ?></a>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                            <lord-icon
                                src="<?php echo e(URL::asset('assets/icons/981-consultation-gradient-edited.json')); ?>"
                                trigger="loop"
                                colors="primary:#464fed,secondary:#bc34b6" style="width:55px;height:55px">
                            </lord-icon>
                        </div>
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <div class="card card-animate">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1 overflow-hidden">
                        <a href="<?php echo e(route('sharessolde' , app()->getLocale() )); ?> "
                               class="text-decoration-underline"><p class="text-uppercase fw-medium text-muted text-truncate   mb-0"><?php echo e(__('Actions (Shares)')); ?></p></a>
                        </div>
                        <div class="flex-shrink-0">
                            <h5 class="text-success fs-14 mb-0">


                                    <p class="text-success" style="max-height: 5px"><?php echo e(actualActionValue(getSelledActions())); ?>
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-3">
                        <div>
                            ...
                            <h3 class="mb-4 fs-22 fw-semibold ff-secondary"><span class="counter-value"
                                                                                   data-target="<?php echo e(getUserSelledActions(Auth()->user()->idUser)); ?>">0</span>
                                  <small class="text-muted fs-13">
                            ...
                            <button data-bs-target="#buy-action" data-bs-toggle="modal"
                               class="btn btn-sm btn-secondary"><?php echo e(__('Buy Shares')); ?></button>
                            <span class="badge bg-light text-success  ms-2 mb-0"><i class="ri-arrow-up-line align-middle"></i><?php echo e(number_format(getUserActualActionsProfit(Auth()->user()->idUser),2)); ?> $</span>

                        </div>
                        <div class="avatar-sm flex-shrink-0">
                            <lord-icon
                                src="<?php echo e(URL::asset('assets/icons/wired-gradient-751-share.json')); ?>" trigger="loop"
                                colors="primary:#464fed,secondary:#bc34b6" style="width:55px;height:55px">
                            </lord-icon>
                        </div>
        ...
        <h4 class="card-title" style="text-align: center"><?php echo e(__('we_are_present_in')); ?> </h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5 style="color:#464fed" ><?php echo e(__('buy_shares_notice')); ?></h5>
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                <a href="<?php echo e(route('user_balance_cb',app()->getLocale())); ?>">
                                    <p class="text-uppercase fw-medium     mb-0 ms-2">
                                        <?php echo e(__('Cash Balance')); ?></p>
                                    <h5 class="fs-14 mb-0 ms-2">
                                        <?php echo e(__('DPC')); ?>  <?php echo $solde->soldeCB /1 ?>
                                    </h5></a>
                            </div>
                            <div class="flex-shrink-0">
                    ...
                    <div class="ms-1 header-item  d-flex me-5">
                        ...
                        <div class="d-flex align-items-center logoTopBFSLabel">
                            <div class="flex-grow-1 overflow-hidden">
                                <a href="<?php echo e(route('user_balance_bfs',app()->getLocale())); ?>">
                                    <p class="text-uppercase fw-medium     mb-0 ms-2">
                                        <?php echo e(__('Balance For Shopping')); ?></p>
                                    <h5 class="text-success fs-14 mb-0  ms-2">

                                        <?php echo e(__('DPC')); ?> <?php echo $solde->soldeBFS /1 ?>
                                    </h5></a>
                            </div>
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                <a   href="<?php echo e(route('user_balance_db',app()->getLocale())); ?>">
                                    <p
                                        ...
                                        <?php echo e(__('Discounts Balance')); ?></p>
                                    <h5   class="text-secondary fs-14 mb-0 ms-2">

                                        <?php echo e(__('DPC')); ?> </span> <?php  echo $solde->soldeDB /1 ?>
                                    </h5></a>
                            </div>
                            <div class="flex-shrink-0">
                ...
                <form class="needs-validation" novalidate >
                    <div class="row g-3">
                        ...
                        <div class="col-xxl-6 d-none" id="contact-select">
                            <div>
                                <label for="firstName" class="form-label"><?php echo e(__('Mobile_Number')); ?></label>
                        ...
                        <div class="col-xxl-6 d-none" id="bfs-select">
                            ...
                            <label  class="form-label mb-3"><?php echo e(__('BFS bonuses  for')); ?> </label>
                            <div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio" name="bfs-for"   value="me">
                                                                        <label class="form-check-label" ><?php echo e(__('me')); ?></label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="radio" name="bfs-for"   value="other">
                                                                        <label class="form-check-label"><?php echo e(__('The chosen user')); ?></label>
                                                                    </div>
                            </div>
                        </div><!--end col-->
                        ...
                        <div class="col-12">
                            ...
                            <label for="customer-name" class="col-form-label"><?php echo e(__('Amount_pay')); ?>($)</label>
                            <div class="input-group">

                                                                <input aria-describedby="simulate" type="number" max="<?php echo e(intval($cashBalance)); ?>"  placeholder="<?php echo e($cashBalance); ?>" class="form-control" id="ammount" required>
                                                                <button type="button"   id="simulate" class="btn btn-outline-primary"><?php echo e(__('simulate')); ?></button>

                            </div>
                        </div><!--end col-->
                        <div class="col-12">
                            <div>
                                                                <label for="customer-name" class="col-form-label"><?php echo e(__('Number Of Shares')); ?> </label>
                                                                <input type="number"  disabled class="form-control" id="number-of-action" value="0000" >

                            </div>
                            <div class="col-12">
                            <div>
                                                                <label for="customer-name" class="col-form-label"><?php echo e(__('Gifted Shares')); ?></label>
                                                                <input type="number"  disabled class="form-control" id="number-of-gifted-action" value="0000" >
                            </div>
                        </div><!--end col-->
                            <div class="col-12 mb-3">
                                <div>
                                    <label for="customer-name" class="col-form-label"><?php echo e(__('Profit')); ?>($) </label>
                ...
                if ($('#inlineRadio2').is(':checked')) {
                    ...
                    $(document).on("click", "#simulate", function () {
                       // console.log($("#ammount").val());
                        $.ajax({
                            url: "<?php echo e(route('action-by-ammount')); ?>",
                            type: "GET",
                            data: {
                                ammount: $("#ammount").val(),
...
// Utilisation de la fonction générique avec votre exemple
            ...
            $(document).on("click", "#buy-action-submit", function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('buyAction')); ?>",
                    type: "POST",
                    data: {
    ...
    <script >
        ...
        anychart.onDocumentReady(function ()  {
            ...
            anychart.data.loadJsonFile(
                "<?php echo e(route('API_stat_countries',app()->getLocale())); ?>",
                function (data) {
...
<?php /**PATH C:\Users\ghazi\Documents\GitHub\2earnprod\resources\views/livewire/home.blade.php ENDPATH**/ ?>